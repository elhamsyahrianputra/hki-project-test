...
<div class="bs-toast toast fade show bg-success position-fixed start-50 translate-middle-x" style="top: 20px; width: 40%" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="ms-2 toast-header align-items-center">
        <div class="bx bx-check-circle me-2" style="font-size: 60px"></div>
        <div class="me-auto fw-semibold fs-4">
            Sukses
            <div class="fs-6 mb-3">{{ session('updateProfile') }}</div>
        </div>
...
<div class="card mb-4">
    <div class="d-flex align-items-center justify-content-between">
        ...
        <h6 class="card-header fw-bold"><span class="text-muted fw-light">Pengaturan /</span> Profil</h6>
    </div>
</div>
